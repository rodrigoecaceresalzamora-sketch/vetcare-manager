...
CREATE TABLE IF NOT EXISTS public.clinic_config (
    ...
    primary_color text NOT NULL DEFAULT '#a65d80',
    secondary_color text NOT NULL DEFAULT '#fdf2f7',
    ...
    email_subject_booking text DEFAULT 'Confirmación de Cita - VetCare',
    email_body_booking text DEFAULT 'Hola {tutor}, tu cita para {mascota} ha sido recibida correctamente para el día {fecha} a las {hora}.',
    email_subject_reminder text DEFAULT 'Recordatorio de Vacunación - VetCare',
    email_body_reminder text DEFAULT 'Hola {tutor}, te recordamos que se acerca el refuerzo de la vacuna {vacuna} para {mascota}. Fecha sugerida: {fecha}.',
    -- Estructura de horarios: { "2": ["10:00", "10:30"], "3": [...] }
    schedule jsonb DEFAULT '{"1":["10:00","11:00","12:00","13:00","15:00"],"2":["10:00","11:00","12:00","13:00","15:00"],"3":["10:00","11:00","12:00","13:00","15:00"],"4":["10:00","11:00","12:00"],"6":["10:00","11:00","12:00","13:00"]}'::jsonb,
